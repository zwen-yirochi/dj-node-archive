    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="relative max-h-[90vh] w-full max-w-2xl overflow-hidden rounded-2xl border border-stone-300 bg-white shadow-xl"
            ...
            >
                ...
                {/* Footer */}
                <div className="flex items-center justify-between border-t border-stone-200 bg-stone-50 p-4">
                    <div>
                        {!isNew && onDelete && (
                            <button
                                onClick={onDelete}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 rounded-lg bg-stone-900 px-6 py-2 font-medium text-white transition-colors hover:bg-stone-800 disabled:cursor-not-allowed disabled:bg-stone-300"
                        >
                    ...
                    <AnimatePresence>
                        {showSuggestions && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -10 }}
                                className="absolute left-0 right-0 top-full z-10 mt-1 rounded-lg border border-stone-200 bg-white py-1 shadow-lg"
                            >
                ...
                >
                    {component.coverUrl ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-1 text-xs text-stone-400">권장: 1:1 정사각형</p>
                            <input
                                type="text"
                                placeholder="또는 이미지 URL 입력"
                                className="mt-4 w-full rounded-lg border border-stone-300 bg-white px-3 py-2 text-center text-sm focus:border-stone-500 focus:outline-none focus:ring-1 focus:ring-stone-500"
