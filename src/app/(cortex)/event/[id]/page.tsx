    ...
    return (
        <div className="mx-auto max-w-cortex px-4 md:px-cortex-gutter">
            ...
            <section className="pb-4 pt-6 md:pt-8">
                {event.posterUrl ? (
                    <div className="mx-auto w-full overflow-hidden border border-cortex-ink-faint md:max-w-[480px]">
                        <img
                            src={event.posterUrl}
                            alt={event.title}
                    ...
                    <div className="mx-auto flex aspect-[3/4] w-full items-center justify-center border border-cortex-ink-faint bg-cortex-bg-dark md:max-w-[480px]">
            ...
            <section className="pb-6">
                ...
                <div className="mt-2 text-cortex-meta-val tracking-[0.5px] text-cortex-ink-light">
                    ...
                    <section className="my-5">
                        ...
                        <div className="my-3">
                            {event.lineup.map((artist, i) => (
                                <div
                                    key={i}
                                    className="flex items-center gap-3 border-b border-dotted border-cortex-ink-faint py-2.5 last:border-b-0"
                                >
                                    ...
                                    <span className="flex-1 text-cortex-body font-medium uppercase">
                                        {artist.name}
                                    </span>
                                </div>
                            ))}
            ...
            {event.description && (
                <>
                    ...
                    <section className="my-5">
                        ...
                        <p className="my-3 whitespace-pre-wrap text-cortex-body leading-relaxed text-cortex-ink-mid">
                            {event.description}
                        </p>
                    </section>
                </>
                        ...
                        <div className="my-3 flex flex-col gap-2">
                            {event.links.map((link, i) => (
                                <a
                                    ...
                                    className="flex items-center justify-between border border-cortex-ink-faint px-4 py-3 text-cortex-meta-val uppercase tracking-cortex-system text-cortex-ink-mid no-underline hover:border-cortex-ink-light hover:text-cortex-ink"
                                >
                                    <span>{link.title}</span>
                                    <span className="text-cortex-ink-ghost">&rarr;</span>
                                </a>
                            ))}
                        </div>
                    </section>
