...
export interface CortexDiscoveryContentProps {
    initialVenues?: DBVenueSearchResult[];
}

export function CortexDiscoveryContent({ initialVenues = [] }: CortexDiscoveryContentProps) {
    ...
    return (
        <div>
            ...
            {isLoading ? (
                <div className="py-12 text-center text-cortex-label uppercase tracking-cortex-system text-cortex-ink-ghost">
                    // SCANNING...
                </div>
